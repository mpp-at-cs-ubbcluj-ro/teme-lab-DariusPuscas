...
public class MainFXSpring extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            FXMLLoader loader = new FXMLLoader(MainFXSpring.class.getResource("RepairShopWindow.fxml"));
    ...
    static ComputerRepairServices getService() throws ServicesException {
          ...
          // ApplicationContext context=new ClassPathXmlApplicationContext("start.RepairShopConfig.xml");
