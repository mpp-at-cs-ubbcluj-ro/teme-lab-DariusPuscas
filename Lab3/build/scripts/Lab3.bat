...
set CLASSPATH=%APP_HOME%\lib\Lab3-1.0-SNAPSHOT.jar;%APP_HOME%\lib\log4j-core-2.20.0.jar;%APP_HOME%\lib\log4j-api-2.20.0.jar;%APP_HOME%\lib\sqlite-jdbc-3.41.2.2.jar
